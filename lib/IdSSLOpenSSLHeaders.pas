...
{
  Changes:
  Previous changes to fit 0.9.7i --- by Liu Yang 2005.11.15

  ---

  Now fits OpenSSL 0.9.8e (Stable) with preinstalled Indy 9 / 10
  July, 5th 2007, digivendo GmbH, Arvid Winkelsdorf

  Updated to OpenSSL 0.9.8g (Stable) with preinstalled Indy 9 / 10
  Oct, 23rd 2007, digivendo GmbH, Arvid Winkelsdorf

  Updated to OpenSSL 0.9.8h (Stable) with preinstalled Indy 9 / 10
  Jun, 2nd 2008
  Copyright (c) 2008 digivendo GmbH, Arvid Winkelsdorf

  - rename IdSSLOpenSSLHeaders9.pas or IdSSLOpenSSLHeaders10.pas
    depending on the Indy version you installed with Delphi to
    IdSSLOpenSSLHeaders.pas
}

{$MESSAGE HINT 'Using Indy OpenSSL 0.9.8h'}
...
Const
  ...
  OPENSSL_OPENSSL_VERSION_NUMBER = $0090808F;  // update to Indy SSL 0.9.8h --- by Arvid Winkelsdorf 05/02/2008
...
var
  ...
  // LIBEAY functions - open SSL 0.9.8h
...
const
  ...
  // begin update to Indy OpenSSL 0.9.8h
  ...
  // end update to Indy OpenSSL 0.9.8h
